    ...
    >
      <Card style={{ minWidth: 275, maxWidth: 600, width: "100%", padding: 20 }}>
        ...
        <Box style={{marginTop: 15, display: "flex", gap: 15}}>
            <Button size="small" color="primary" variant="contained" type="submit" disabled={isLoading}>Sign up</Button>
            <Button size="small" color="primary" onClick={() => navigate(EnumRoutes.SignIn)}>Sign in</Button>
        </Box>
        </form>
      </Card>
    </Box>
